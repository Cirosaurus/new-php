...
// LOGIKA PENYIMPANAN SEMENTARA (Hanya Tampilan Pesan Sukses)
$pesan_sukses = "";
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logout-btn {
            background-color: #ffebe9; color: #cf222e; padding: 8px 16px;
        ...
        .alert-success {
            ...
            border-radius: 8px; margin-bottom: 20px; border: 1px solid #c3e6cb; text-align: center;
        }
        ...
        .accordion-header {
            width: 100%; background-color: #fff; padding: 20px 25px;
            text-align: left; border: none; outline: none; cursor: pointer; transition: 0.3s;
            display: flex; justify-content: space-between; align-items: center;
            font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 600; color: #333;
        }
        ...
        .accordion-body {
            padding: 0 25px; background-color: white; max-height: 0;
        ...
        .checkbox-group label { font-weight: 400; font-size: 14px; line-height: 1.5; }

        .btn-submit {
            display: block; width: 100%; margin-top: 30px;
            padding: 15px; background-color: #004699; color: white;
...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="POST">
                    ...
                    <div class="accordion-body" style="max-height: 1000px;">
                        <div class="form-content">
                            ...
                            <div class="form-group">
                                ...
                                <span class="desc-text">(penulisan lengkap dan tidak disingkat, contoh: Kabupaten Gayo Lues, Kabupaten Labuhanbatu Selatan)</span>
                                <input type="text" name="kabupaten" class="form-control" placeholder="Jawaban Anda" required>
                            </div>
            ...
            </div> <button type="submit" class="btn-submit">Kirim</button>
    ...
    <script>
        ...
        for (let i = 0; i < acc.length; i++) {
            acc[i].addEventListener("click", function() {
                // Tutup panel lain (opsional, jika ingin satu saja yang terbuka)
